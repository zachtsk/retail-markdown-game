<script>
	...
	import { coef, cost, price, intercept, stageHeight, stageWidth } from '../lib/game_definition';
    ...
    const startRound = () => {
        ...
        round.createShoppers();

        const animate = () => {
            round.waveStep()
            console.log(round.calculateShopperStats())
...
class="mx-5 mt-2 px-3 py-1 rounded-lg bg-blue-500 text-white text-lg font-semibold hover:bg-blue-600 active:translate-y-[1px]">Start Round</button>
